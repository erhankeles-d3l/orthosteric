...
**Companion documents** (same directory, read alongside this one, not duplicated here):
`ADR-0003_GATE_READINESS_EVIDENCE_PLAN.md` (evidence matrix across all five questions),
`ADR-0003_THRESHOLD_ANALYSIS.md` (AUDITOR-2 reproducible power/null-model analysis),
`ADR-0003_METHODOLOGICAL_CONSIDERATIONS.md` (AUDITOR-1/3/4 technical analysis),
`ADR-0003_ATP_KM_EVIDENCE_REVIEW.md` (AUDITOR-5, verified literature evidence),
`ADR-0003_CROSS_DECISION_DEPENDENCIES.md` (interactions among all five questions).
